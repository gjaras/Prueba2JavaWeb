...
public class UsuarioController implements Serializable {
    ...
    @EJB
    private classes.UsuarioFacade ejbFacade;
    ...
    public String performLogin() {
        ...
        try {
            Usuario usuario=getFacade().find(current.getLogin());
            System.out.println("USUARIO FOUND");
            if(usuario != null && usuario.getPassword().equals(clave))
                return "/index";
            else{
                JsfUtil.addErrorMessage(ResourceBundle.getBundle("/Bundle").getString("UsuarioNotFoundError"));
                current.setPassword("");
                return null;
            }    
        } catch (Exception e) {
