...
public class RegionController implements Serializable {
    ...
    @EJB
    private classes.RegionFacade ejbFacade;
    ...
    public String buscarRegion(Object obj){
